<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $query = "INSERT INTO articlesss (title, content) VALUES ('$title', '$content')";
        mysqli_query($conn, $query);
    }

    // Fetch all of the articles from the database
    $query = "SELECT * FROM articlesss ORDER BY id DESC";
...
<header role="banner">
  ...
  <ul class="utilities">
    <br>
    <li ><a href="captains.php">Captain Accounts</a></li>
    <li ><a href="staffs.php">Staff Accounts</a></li>
  </ul>
</header>
...
<nav role='navigation'>
  <ul class="main">
    ...
    <li class="edit"><a href="captainregister.php">Create Captain Account</a></li>
    <li class="write"><a href="staffregister.php">Create Staff Account</a></li>
    <li class="comments"><a href="#wr">Write Articles</a></li>
    <li class="users"><a href="#re">Current Articles</a></li>
  </ul>
</nav>
...
<main role="main">
  ...
  <section class="panel important" id="wr">
    <h2>Write a post</h2>
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <div class="twothirds">
          ...
          Content:<br/>    
          <textarea name="content" rows="15" cols="67"></textarea><br/>  
        </div>
        <div>
        ...
        <h2 id="re">Current Articles</h2><br><br>
        <table >
        <tr>
            <th>Title</th>
			<th>content</th>
        ...
        <?php while($row = mysqli_fetch_array($result)): ?>
            <tr>
                ...
                <td><a href="edit_article.php?id=<?php echo $row["id"]; ?>">Edit</a></td>
                <td><a href="delete_article.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
            </tr>
        <?php endwhile; ?>
    </table>
        </div>
