...
<body>
  <div class="header">
  	<h2>Captain Register</h2>
  </div>
	
  <form method="post" action="captainregister.php">
  	<?php include('caperrors.php'); ?>
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="reg_captain">Register</button>
  	</div>
  	<p>
